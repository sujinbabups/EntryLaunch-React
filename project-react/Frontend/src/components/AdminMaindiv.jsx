            ...
            <div className="main h-[600px] w-[70%] bg-gray-300 mx-auto mt-10 rounded-lg flex">
                ...
                <div className="dash bg-gradient-to-r from-blue-300 to-blue-700 text-white p-8 rounded-lg mr-8 mt-12 h-[440px] ml-[5%] ">
                    ...
                    <Link to ="#vwemp" className="block my-2">
                        <input type="submit" onclick="viewEmployers()" onClick={handleviewEmployer} value="View Employers" className="bg-purple-900 text-white py-2 px-4 rounded cursor-pointer w-[95%] hover:bg-purple-600" />
                    </Link>
                    ...
                    <Link to ="/" className="block my-2">
                        <input type="submit" value="Logout" className="bg-purple-900 text-white py-2 px-4 rounded cursor-pointer  hover:bg-purple-600 w-[95%]" />
                    </Link>
