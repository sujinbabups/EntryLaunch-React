...
const Adminlogin = ({show,handleClose}) => {
  ...
  return (
   <>
    <div id="admlog" className="fixed top-[200px] right-[10px] bg-white w-1/4 p-6 rounded-lg shadow-lg ">
        ...
        <form className="mt-6" onSubmit={loginSubmit}>
            ...
            <input type="text" name="username" id="uname" value={username} onChange={(e) => setUsername(e.target.value)}
                className="block w-full h-10 bg-gray-300 rounded-lg text-center text-lg mt-2 mb-4" placeholder="username"/>
